...
ids = next(os.walk("songs"))[2] # list of names all images in the given path
...
for n, id_ in tqdm_notebook(enumerate(ids), total=len(ids)):
    # Load images
    img = load_img('.\\songs\\'+id_, color_mode = "grayscale")
    ...
    mask = img_to_array(load_img('masks/' + id2_, color_mode="grayscale"))
...
input_img = Input((im_height, im_width, 1), name='love-me-do.jpg')
